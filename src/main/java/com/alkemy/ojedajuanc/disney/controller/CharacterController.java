...
public class CharacterController {
	...
	@PutMapping("/{id}")
	public ResponseEntity<Optional<CharacterDTO>> updateCharacter(@PathVariable("id") Long id, @RequestBody CharacterDTO character) {
		Optional<CharacterDTO> updatedCharacter = service.updateCharacter(id, character);
		return new ResponseEntity<Optional<CharacterDTO>>(updatedCharacter, HttpStatus.OK);
	}
